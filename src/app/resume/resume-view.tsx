...
// Drop the compiled PDF here: frontend/public/Nandeesh_Shetty_Resume.pdf
const RESUME_PATH = "/Nandeesh_Shetty_Resume.pdf";
    ...
    <div className="flex min-h-screen flex-col font-sans">
      ...
      <div className="mx-auto w-full max-w-4xl shrink-0 px-4 pt-16 md:pt-24">
        ...
        >
          ...
          <a
            href={RESUME_PATH}
            download="Nandeesh_Shetty_Resume.pdf"
