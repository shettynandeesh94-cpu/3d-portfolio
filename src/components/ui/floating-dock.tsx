  ...
  return (
    <div className="relative h-fit flex items-center justify-center pointer-events-auto">
      <motion.div
        ...
        className={cn(
          "flex flex-wrap sm:flex-nowrap gap-2 md:gap-4",
          "mx-auto min-h-[4rem] h-auto sm:h-16 items-center sm:items-end justify-center rounded-2xl bg-white/30 dark:bg-black/50 p-2 sm:px-4 sm:pb-3 max-w-full overflow-x-auto",
          className
        )}
      >
        {items.map((item) => (
